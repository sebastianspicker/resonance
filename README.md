...
For command-line verification on macOS with Xcode installed:

```bash
cd ios/ResonanceApp
xcodebuild -scheme ResonanceApp -destination 'generic/platform=iOS Simulator' build-for-testing
```
